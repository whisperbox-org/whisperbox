    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          <div className='flex flex-row px-4 py-2 rounded-lg bg-secondary items-center'>
            <div className={`w-3 h-3 ${health == HealthStatus.MinimallyHealthy || health == HealthStatus.SufficientlyHealthy ? "bg-green-400" : "bg-red-400"} rounded-full mr-2 animate-pulse-subtle`}></div>
            Waku
          </div>
          <WalletConnect />
        </div>
